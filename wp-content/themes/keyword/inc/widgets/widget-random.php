 ...
 * @since      1.0.0
 */
class keyword_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-keyword-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'keyword' )
		);

		// Create the widget.
		parent::__construct(
			'keyword-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'keyword' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'keyword' ),
			'limit'     => 5,
			'show_date' => true
		);
