 ...
 * @since      1.0.0
 */
class keyword_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-keyword-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'keyword' )
		);

		// Create the widget.
		parent::__construct(
			'keyword-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'keyword' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'keyword' ),
			'limit'     => 5,
			'show_date' => true
		);
