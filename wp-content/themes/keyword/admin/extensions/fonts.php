...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'keyword Fonts', 'keyword' ) ) ) );
	$keyword_fonts = customizer_library_get_keyword_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'keyword' ) ) ) );
	 ...
	 */
	return apply_filters( 'customizer_library_all_fonts', array_merge( $heading1, $keyword_fonts, $heading2, $google_fonts ) );
}
endif;
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'keyword' ),
		'cyrillic'     => __( 'Cyrillic', 'keyword' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'keyword' ),
		'devanagari'   => __( 'Devanagari', 'keyword' ),
		'greek'        => __( 'Greek', 'keyword' ),
		'greek-ext'    => __( 'Greek Extended', 'keyword' ),
		'khmer'        => __( 'Khmer', 'keyword' ),
		'latin'        => __( 'Latin', 'keyword' ),
		'latin-ext'    => __( 'Latin Extended', 'keyword' ),
		'vietnamese'   => __( 'Vietnamese', 'keyword' ),
	);
}
endif;
...
if ( ! function_exists( 'customizer_library_get_keyword_fonts' ) ) :
/**
 * Return an array of keyword websafe fonts.
 *
 * @since  1.0.0.
 *
 * @return array    keyword websafe fonts.
 */
function customizer_library_get_keyword_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'keyword' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'keyword' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'keyword' ),
...
function customizer_library_get_google_fonts() {
	return apply_filters( 'customizer_library_get_google_fonts', array(
		...
		'Old keyword TT' => array(
			'label'    => 'Old keyword TT',
			'variants' => array(
				'regular',
				'italic',
				'700',
